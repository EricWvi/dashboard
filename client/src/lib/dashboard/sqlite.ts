...
export class SqliteDashboardDatabase implements IDashboardDatabase {
  ...
  async getBlog(id: string): Promise<Blog | undefined> {
    return (
      (await invoke<Blog | null>("dashboard_get_blog", { id })) ?? undefined
    );
  }

  async getAllBlogs(): Promise<Blog[]> {
    return invoke("dashboard_get_all_blogs");
  }
  ...
  async getBookmark(id: string): Promise<Bookmark | undefined> {
    return (
      (await invoke<Bookmark | null>("dashboard_get_bookmark", { id })) ??
      undefined
    );
  }

  async getAllBookmarks(): Promise<Bookmark[]> {
    return invoke("dashboard_get_all_bookmarks");
  }
  ...
  async getAllCollections(): Promise<Collection[]> {
    return invoke("dashboard_get_all_collections");
  }
  ...
  async getEcho(id: string): Promise<Echo | undefined> {
    return (
      (await invoke<Echo | null>("dashboard_get_echo", { id })) ?? undefined
    );
  }

  async getAllEchoes(): Promise<Echo[]> {
    return invoke("dashboard_get_all_echoes");
  }
  ...
  async getAllQuickNotes(): Promise<QuickNote[]> {
    return invoke("dashboard_get_all_quick_notes");
  }
  ...
  async getTag(id: string): Promise<Tag | undefined> {
    return (
      (await invoke<Tag | null>("dashboard_get_tag", { id })) ?? undefined
    );
  }
  ...
  async getTodo(id: string): Promise<Todo | undefined> {
    return (
      (await invoke<Todo | null>("dashboard_get_todo", { id })) ?? undefined
    );
  }

  async getAllTodos(): Promise<Todo[]> {
    return invoke("dashboard_get_all_todos");
  }
  ...
  async getWatch(id: string): Promise<Watch | undefined> {
    return (
      (await invoke<Watch | null>("dashboard_get_watch", { id })) ?? undefined
    );
  }

  async getAllWatches(): Promise<Watch[]> {
    return invoke("dashboard_get_all_watches");
  }
