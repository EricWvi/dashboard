...
#[cfg(feature = "flomo")]
const OIDC_REDIRECT_URI_ENCODED: &str = "flomo%3A%2F%2Foidc%2Fcallback";
#[cfg(feature = "dashboard")]
const OIDC_REDIRECT_URI_ENCODED: &str = "dashboard%3A%2F%2Foidc%2Fcallback";
#[cfg(feature = "journal")]
const OIDC_REDIRECT_URI_ENCODED: &str = "journal%3A%2F%2Foidc%2Fcallback";
#[cfg(not(any(feature = "flomo", feature = "dashboard", feature = "journal")))]
const OIDC_REDIRECT_URI_ENCODED: &str = "flomo%3A%2F%2Foidc%2Fcallback";
