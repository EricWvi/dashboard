...
// --- Tiptap UI ---
import type { UseVideoUploadConfig } from "../video-upload-button";
import {
  VIDEO_UPLOAD_SHORTCUT_KEY,
  useVideoUpload,
} from "../video-upload-button";
 ...
 *
 * For custom button implementations, use the `useVideoUpload` hook instead.
 */
