...
- **Documentation**
  - Update `docs/server/server.md` and `docs/api/` to ensure they are up-to-date with the latest architecture and design decisions.
...
- **Development Workflow**:
  ...
  5.  **Review**: Update `docs/server/dev-log.md` with a concise summary of changes.
